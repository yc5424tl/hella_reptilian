...
class Merch(db.Model):
    ...
    rel_sales_id = db.relationship("Sales", foreign_keys=merch_id, back_populates="rel_merch_id")
    rel_sales_name = db.relationship("Sales", foreign_keys=merch_name, back_populates="rel_merch_name")
    #
    # sales = db.relationship('Sales', cascade="save-update, merge, delete")
